...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
    ...
    return (
        ...
        <Dialog.Content className="fixed overflow-hidden md:left-1/2 md:top-1/2 md:-translate-x-1/2 inset-0 md:inset-auto md:-translate-y-1/2 md:max-w-[640px] w-full md:h-[60vh] bg-slate-700 md:rounded-md flex flex-col outline-none"> 
